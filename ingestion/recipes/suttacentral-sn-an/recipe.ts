...
export const hooks: RecipeHooks<Parsed, Parsed> = {
  ...
  map(parsed, context) {
    ...
    records.push({ id: PROVENANCE, record_type: 'provenance', source: artifact('sn'), source_reference: `SuttaCentral bilara-data published@${COMMIT}, SN and AN Sujato translation files`, activities: [{ type: 'acquisition', method: 'Pinned 3,227 GitHub source files with per-file SHA-256 manifest', software: { name: 'mw:recipe:suttacentral:sn-an-sujato', version: '1' }, ended_at: '2026-08-27T00:00:00Z' }, { type: 'normalization', method: 'Identity; Bilara segment values are preserved exactly', software: { name: 'mw:recipe:suttacentral:sn-an-sujato', version: 'identity-1' } }] } as CorpusRecord)
