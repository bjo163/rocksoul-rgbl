...
import type { ProvenanceActivity } from './provenance.js'
...
export interface Provenance extends BaseRecord { record_type:'provenance'; source:CanonicalId; source_reference?:string; activities:ProvenanceActivity[]; extensions?:Record<string,unknown> }
