...
async function main(): Promise<void> {
  ...
  const records: CorpusRecord[] = [
    ...
    { id: ids.provenance, record_type: 'provenance', source: ids.artifact, source_reference: `Project Gutenberg #7145; SHA-256 ${sourceHash}`, activities: [{ type: 'acquisition', method: 'Download and identity-validate pinned plain-text source', software: { name: 'scripts/materialize-ancient-egypt-book-of-dead-budge.ts', version: '1' } }, { type: 'parsing', method: 'Parse printed CHAPTER headings and preserve chapter bodies', software: { name: 'scripts/materialize-ancient-egypt-book-of-dead-budge.ts', version: '1' } }] }
  ]
